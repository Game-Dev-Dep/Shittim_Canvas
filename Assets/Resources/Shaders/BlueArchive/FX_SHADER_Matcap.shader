Shader "DSFX/FX_SHADER_Matcap"
{
    Properties
    {
        [HDR]_Main_Color("Main Color", Color) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Sample main texture
                half3 mainColor = SAMPLE_TEXTURE2D(_Main_Tex, sampler_Main_Tex, input.uv).rgb;
                mainColor *= _Main_Color.rgb * input.color.rgb;
                ...
                // Combine colors
                half3 finalColor = mainColor * matcap.rgb;
                //half alpha = matcap.a * input.color.a * _Main_Color.a;
