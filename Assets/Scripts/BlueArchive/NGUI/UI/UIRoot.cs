...
// Copyright Ä€Ā© 2011-2023 Tasharen Entertainment Inc
//-------------------------------------------------
...
public class UIRoot : MonoBehaviour
{
	...
	protected virtual void Start ()
	{
		...
		UICamera ui_camera = GetComponentInChildren<UICamera>();
		Camera_Services.Instance.Set_MemoryLobby_Camera(ui_camera.gameObject.GetComponent<Camera>());
